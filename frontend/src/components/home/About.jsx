...
const About = () => {
  ...
  return (
    <section id="about" className="section-padding bg-white overflow-hidden w-full">
      <div className="container-custom w-full">
        <AnimatedSection variant="fadeIn" className="text-center mb-10 md:mb-16">
          <motion.span
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center mb-10 md:mb-16">
            ...
            <div className="relative px-4 md:px-0">
              <div className="rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-900 to-gray-800">
                <img
                  ...
                  className="w-full h-[250px] sm:h-[300px] md:h-[400px] object-contain"
                  onError={(e) => {
              ...
              <motion.div
                className="absolute -bottom-3 -right-3 md:-bottom-6 md:-right-6 bg-saffron text-white p-3 md:p-6 rounded-xl md:rounded-2xl shadow-xl"
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 px-4 md:px-0">
          {features.map((feature, index) => (
            <AnimatedSection
              key={index}
              variant="scaleIn"
              className="glass-card p-3 md:p-6 text-center hover-lift"
            >
              <motion.div
                className="w-10 h-10 md:w-16 md:h-16 bg-gradient-to-br from-saffron to-gold rounded-full flex items-center justify-center mx-auto mb-2 md:mb-4"
                whileHover={{ rotate: 360 }}
                whileTap={{ rotate: 360, scale: 1.1 }}
                transition={{ duration: 0.6 }}
              >
                <feature.icon className="text-white text-base md:text-2xl" />
              </motion.div>
              <h4 className="font-bold text-xs md:text-lg mb-1 md:mb-2">{feature.title}</h4>
